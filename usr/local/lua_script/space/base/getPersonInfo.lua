...
local sel_person = "SELECT person_id,person_name,avatar_url from t_base_person WHERE BUREAU_ID = "..school_id.." AND person_id <> "..person_id.." AND B_USE = 1 AND IDENTITY_ID = "..identity_id.." limit "..limit;
local total_sql = "SELECT count(*) as totalRow from t_base_person WHERE BUREAU_ID = "..school_id.." AND person_id <> "..person_id.." AND B_USE = 1 AND IDENTITY_ID = "..identity_id;

--[[
空间我的资源、试卷、试题、备课、微课等模块要求不登录时访问我的共享
从/usr/local/lua_script/paper_list_my.lua拷贝，改成不登录即可访问
@Author  feiliming
@Date    2015-5-11
]]
...
local cookie_person_id = tostring(args["person_id"])
--判断是否有person_id
...
local cookie_identity_id = tostring(args["identity_id"])
--判断是否有identity_id

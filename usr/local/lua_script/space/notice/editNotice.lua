...
--default
local thumbnail_sql = thumbnail and ", thumbnail = "..quote(thumbnail) or ""
...
local stage_id_sql = stage_id and ", stage_id = "..quote(stage_id) or ""
local stage_name_sql = stage_name and ", stage_name = "..quote(stage_name) or ""
local subject_id_sql = subject_id and ", subject_id = "..quote(subject_id) or ""
local subject_name_sql = subject_name and ", subject_name = "..quote(subject_name) or ""

local update_ts = TS.getTs()
local isql = "UPDATE t_social_notice SET title = "..quote(title)..overview_sql..
    ", content = "..quote(content)..category_id_sql..thumbnail_sql..stage_id_sql..stage_name_sql..subject_id_sql..subject_name_sql..
